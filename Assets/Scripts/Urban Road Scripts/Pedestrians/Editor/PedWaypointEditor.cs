...
[InitializeOnLoad()]
public class PedWaypointEditor
{
    [DrawGizmo(GizmoType.NonSelected | GizmoType.Selected | GizmoType.Pickable)]
    public static void OnDrawSceneGizmo(PedWaypoint waypoint, GizmoType gizmoType)
    {
        ...
        {
            foreach(PedWaypoint branch in waypoint.branches)
            {
